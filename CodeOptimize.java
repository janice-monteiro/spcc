...
//System.out.println("Matched Expression: " + subexpr);
//System.out.println("From " + m.start() + " to " + m.end());
int result = this.evaluate(subexpr);
//System.out.println("After evaluating: " + result);
...
int len = rhs2.length();
//System.out.println(" Match found from position "+start+" to"+(start+len));

rhs1 = rhs1.replace(rhs1.substring(start,len),lhs2);
//System.out.println(" After replacement: "+rhs1);
